...
1. Run the https://github.com/operandinc/gqlgen/blob/master/bin/release:
...
4. Go to https://github.com/operandinc/gqlgen/releases and draft new release, autogenerate the release notes, and Create a discussion for this release
