...
# https://github.com/operandinc/gqlgen/issues/896.
...
# see https://github.com/operandinc/gqlgen/issues/694
type Content_User {
  foo: String
}
...
`, BuiltIn: false},
	{Name: "weird_type_cases.graphql", Input: `# regression test for https://github.com/operandinc/gqlgen/issues/583
...
type XxIt { id: ID! }
`, BuiltIn: false},
	{Name: "wrapped_type.graphql", Input: `# regression test for https://github.com/operandinc/gqlgen/issues/721
...
func (ec *executionContext) field_Query_directiveInputType_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["arg"]; ok {
		...
		if data, ok := tmp.(InnerInput); ok {
			...
			return nil, graphql.ErrorOnPath(ctx, fmt.Errorf(`unexpected type %T from directive, should be github.com/operandinc/gqlgen/codegen/testserver/singlefile.InnerInput`, tmp))
		}
	}
	args["arg"] = arg0
	return args, nil
...
func (ec *executionContext) _Query_directiveObject(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be *github.com/operandinc/gqlgen/codegen/testserver/singlefile.ObjectDirectives`, tmp)
	})
...
func (ec *executionContext) _Query_noShape(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/operandinc/gqlgen/codegen/testserver/singlefile.Shape`, tmp)
	})
...
func (ec *executionContext) _Query_animal(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/operandinc/gqlgen/codegen/testserver/singlefile.Animal`, tmp)
	})
	...
	for k, v := range asMap {
		...
		case "inner":
			...
			if data, ok := tmp.(*InnerDirectives); ok {
				...
				err := fmt.Errorf(`unexpected type %T from directive, should be *github.com/operandinc/gqlgen/codegen/testserver/singlefile.InnerDirectives`, tmp)
				return it, graphql.ErrorOnPath(ctx, err)
			}
		case "innerNullable":
			var err error
		...
		case "thirdParty":
			...
			if data, ok := tmp.(*ThirdParty); ok {
				...
				err := fmt.Errorf(`unexpected type %T from directive, should be *github.com/operandinc/gqlgen/codegen/testserver/singlefile.ThirdParty`, tmp)
				return it, graphql.ErrorOnPath(ctx, err)
			}
		}
	}
