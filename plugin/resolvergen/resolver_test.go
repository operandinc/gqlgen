...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/operandinc/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/operandinc/gqlgen/plugin/resolvergen/"+dir+"/out")
}
